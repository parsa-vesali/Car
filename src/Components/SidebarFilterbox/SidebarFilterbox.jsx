...
export default function SidebarFilterbox({ sellers, fillterSellers }) {
  ...
  return (
    <>
      ...
      <div className="sidebarFilterbox-mobile">
        <button className="sideBarDilterbox__header-btn-mobile">
          <SavedSearchIcon />
        </button>
        <button
          onClick={() => setmodalMobile(true)}
          className="sidebarFilterbox-mobile__btn"
        >
          <TuneIcon />
          فیلتر کنید
        </button>
        <Modal show={modalMobile} onHide={handleClose}>
          <Modal.Header >
